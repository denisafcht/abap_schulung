...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD ValidateCustomer.
    ...
    DATA travels TYPE TABLE FOR READ RESULT ZR_03_TravelTP.

    " Read Travels "
    READ ENTITIES OF zr_03_traveltp IN LOCAL MODE
         ENTITY Travel
         FIELDS ( CustomerID )
  ...
  METHOD DetermineStatus.
    DATA travels TYPE TABLE FOR UPDATE zr_03_traveltp.
    ...
    MODIFY ENTITIES OF zr_03_traveltp IN LOCAL MODE
           ENTITY travel
           UPDATE
           FIELDS ( Status )
           WITH travels.
